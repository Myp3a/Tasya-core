...
class Core:
    ...
    def reply(self) -> str:
        ...
        if self.lang != "en":
            ...
            conv = Conversation.from_marked_block(self.translator.translate(conv.as_marked_block(), self.lang, "en"), self.request_id, conv)
        ...
        if self.lang != "en":
            ...
            conv = Conversation.from_marked_block(self.translator.translate(conv.as_marked_block(), "en", self.lang), self.request_id, conv)
